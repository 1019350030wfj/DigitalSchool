...
public class FolderListPopupWindow extends PopupWindow {
    ...
    private void init() {
        ...
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, (folderAdapter.getItemCount() > 4
                ? 4 * (int) AppUtils.dipToPx(mContext, 90)
                : folderAdapter.getItemCount() * (int) AppUtils.dipToPx(mContext, 90)));
        rvFolderList.setLayoutParams(layoutParams);
        //设置PopupWindow弹出窗体的宽
        this.setWidth(ViewGroup.LayoutParams.MATCH_PARENT);
        //设置PopupWindow弹出窗体的高
        this.setHeight(ViewGroup.LayoutParams.MATCH_PARENT);
//        this.setHeight(ScreenUtils.getScreenHeight(mContext) * 3 / 4);
