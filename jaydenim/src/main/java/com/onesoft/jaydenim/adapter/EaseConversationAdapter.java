...
import com.onesoft.jaydenim.model.EaseAtMessageHelper;
...
import com.onesoft.jaydenim.widget.EaseConversationList.EaseConversationListHelper;
...
public class EaseConversationAdapter extends ArrayAdapter<EMConversation> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String username = conversation.getId();

        if (conversation.getType() == EMConversation.GROUPCHAT) {
...
//            holder.name.setText(group != null ? group.getGroupName() : username);
        } else if (conversation.getType() == EMConversation.CHATROOM) {
            holder.avatar.setImageResource(R.drawable.ease_group_icon);
...
//            holder.motioned.setVisibility(View.GONE);
        ...
        if (conversation.getAllMsgCount() != 0) {
            ...
            EaseUserUtils.setUserAvatar(getContext(),
                    username,
                    holder.avatar);
            ...
            if (lastMessage.direct() == EMMessage.SEND && lastMessage.status() == EMMessage.Status.FAIL) {
