...
import com.onesoft.jaydenim.domain.VideoEntity;
...
import com.onesoft.jaydenim.utils.video.ImageCache;
import com.onesoft.jaydenim.utils.video.ImageResizer;
import com.onesoft.jaydenim.utils.video.Utils;
import com.onesoft.jaydenim.widget.RecyclingImageView;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			...
			// also takes care of
			// setting item_a placeholder image while the background thread runs
