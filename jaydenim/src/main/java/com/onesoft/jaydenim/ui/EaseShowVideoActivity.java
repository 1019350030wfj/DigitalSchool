...
public class EaseShowVideoActivity extends EaseBaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LogUtil.d(TAG, "show video view file:" + localFilePath
        ...
        if (localFilePath != null && new File(localFilePath).exists()) {
            ...
            LogUtil.d(TAG, "download remote video file");
    ...
    public String getLocalFilePath(String remoteUrl){
        ...
        if (remoteUrl.contains("/")) {
            localPath = PathUtil.getInstance().getVideoPath() + remoteUrl.substring(remoteUrl.lastIndexOf("/") + 1)
                    + ".mp4";
        } else {
            localPath = PathUtil.getInstance().getVideoPath()+ remoteUrl + ".mp4";
        }
        return localPath;
    }
