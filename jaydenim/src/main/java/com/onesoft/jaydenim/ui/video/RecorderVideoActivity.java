 ...
 */
package com.onesoft.jaydenim.ui.video;
...
import com.onesoft.jaydenim.ui.EaseBaseActivity;
...
import com.onesoft.jaydenim.utils.video.Utils;
...
public class RecorderVideoActivity extends EaseBaseActivity implements
    ...
    private boolean initCamera() {
        try {
            ...
            LogUtil.e("video", "init Camera fail " + ex.getMessage());
            return false;
        }
        return true;
    }
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        try {
            ...
            LogUtil.e("video", "start preview fail " + e1.getMessage());
            showFailDialog();
        }
    }
    ...
    public void surfaceDestroyed(SurfaceHolder arg0) {
        LogUtil.e("video", "surfaceDestroyed");
    }
            ...
            msc = new MediaScannerConnection(this,
                    new MediaScannerConnectionClient() {
                        ...
                        public void onScanCompleted(String path, Uri uri) {
                            LogUtil.d(TAG, "scanner completed");
                            msc.disconnect();
    ...
    public void onInfo(MediaRecorder mr, int what, int extra) {
        LogUtil.e("video", "onInfo");
        if (what == MediaRecorder.MEDIA_RECORDER_INFO_MAX_DURATION_REACHED) {
            LogUtil.e("video", "max duration reached");
            stopRecording();
            btn_switch.setVisibility(View.VISIBLE);
            chronometer.stop();
            btnStart.setVisibility(View.VISIBLE);
    ...
    public void saveBitmapFile(Bitmap bitmap) {
        File file = new File(Environment.getExternalStorageDirectory(), "item_a.jpg");
        try {
