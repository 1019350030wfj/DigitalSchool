...
public class MessgeDao {
	...
	public static final String COLUMN_NAME_CONVERSATION_NAME = "conversationName";
	...
	public MessgeDao(Context context){
	}
	...
	public List<EMMessage> getMessageList(String conversationId) {
		return DemoDBManager.getInstance().getAllMessage(conversationId);
	}
	public List<EMMessage> getMessageListByPage(String conversationId, int from, int to) {
		return DemoDBManager.getInstance().getAllMessageByPage(conversationId,from,to);
	}

	public void deleteMessage(String from){
	    DemoDBManager.getInstance().deleteMessage(from);
	}
	public void deleteMessageByConversationId(String from){
	    DemoDBManager.getInstance().deleteMessageByConversationId(from);
	}
}
