...
import com.onesoft.jaydenim.EMError;
import com.onesoft.jaydenim.R;
import com.onesoft.jaydenim.adapter.EaseMessageAdapter;
...
public abstract class EaseChatRow extends LinearLayout {
    ...
    private void setUpBaseView() {
        ...
        if(message.direct() == EMMessage.SEND){
            ...
            EaseUserUtils.setUserAvatar(context, message.getMsgFrom(), userAvatarView);
            usernickView.setText(message.getMsgFromNick());
        }
...
//        }
        ...
        if (adapter instanceof EaseMessageAdapter) {
            ...
            } else if (message.direct() == EMMessage.RECEIVE) {
                ...
                public void onClick(View v) {
                    if (itemClickListener != null) {
                        if (message.direct() == EMMessage.SEND) {
                            ...
                            itemClickListener.onUserAvatarClick(message.getMsgFrom());
                        }
                    }
                }
            });
                ...
                public boolean onLongClick(View v) {
                    if(itemClickListener != null){
                        if (message.direct() == EMMessage.SEND) {
                            ...
                            itemClickListener.onUserAvatarLongClick(message.getMsgFrom());
                        }
                        return true;
                    }
                    return false;
