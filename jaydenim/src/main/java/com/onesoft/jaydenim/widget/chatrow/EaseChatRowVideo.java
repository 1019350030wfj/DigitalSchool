...
//        }
//
//        LogUtil.d(TAG,  "video thumbnailStatus:" + videoBody.thumbnailDownloadStatus());
//        if (message.direct() == EMMessage.RECEIVE) {
...
//	    EMVideoMessageBody videoBody = (EMVideoMessageBody) message.getBody();
        LogUtil.d(TAG, "video view is on click");
            ...
            new AsyncTask<Void, Void, Bitmap>() {
                ...
                protected Bitmap doInBackground(Void... params) {
                    if (new File(localThumb).exists()) {
                        return EaseImageUtils.decodeScaleImage(localThumb, 160, 160);
                    } else {
                        return null;
                    }
                }
