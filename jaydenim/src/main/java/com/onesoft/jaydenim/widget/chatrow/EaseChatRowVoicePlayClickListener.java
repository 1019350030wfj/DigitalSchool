...
import com.onesoft.jaydenim.domain.EMMessage.ChatType;
...
//                    // 告知对方已读这条消息
//                    EMClient.getInstance().chatManager().ackMessageRead(message.getMsgFrom(), message.getMsgId());
//                }
