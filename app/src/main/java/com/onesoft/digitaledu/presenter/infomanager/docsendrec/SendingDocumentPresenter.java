...
public class SendingDocumentPresenter extends BasePresenter<ISendingBoxView> {

    public SendingDocumentPresenter(Context context, ISendingBoxView iView) {
        super(context, iView);
    }

    public void getInBoxData(int page) {//发件箱列表
        StringBuilder builder = new StringBuilder();
        builder.append(HttpUrl.DOCUMENT_SEND_LIST).append("user_id=").append(SPHelper.getUserId(mContext));
    ...
    public void deleteBatch(List<BoxBean> beanList) {
        ...
        builder.append(HttpUrl.SENDBOX_DELELTE_DOC).append(builderIds.toString());
