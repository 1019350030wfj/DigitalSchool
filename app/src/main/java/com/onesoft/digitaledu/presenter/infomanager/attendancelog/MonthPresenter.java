...
public class MonthPresenter extends BasePresenter<IMonthView> {
    ...
    /**
     * 通过年和月，获取日程
     * http://222.47.48.38:8080/new_digitalschool/api/main.php?id=789&template_id=108&query=&user_id=1
     *
     * @param year
     * @param month 不是两位数的必须0补齐
     */
    public void getYearMonth(String year, String month) {
        String url = THREE_MENU_TO_DETAIL + "789&template_id=108"
        ...
        try {
            ...
            /*============这边获取main 列表数据=============*/
                if (keyValues.size() > 0) {
                    ...
                    iView.onGetYearMonthDataError("无考勤");
                }
            } else {
