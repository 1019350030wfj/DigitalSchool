 ...
 */
public class Template42EditDynamicPresenter extends BasePresenter<IEditView> {

    public Template42EditDynamicPresenter(Context context, IEditView iView) {
        super(context, iView);
    }

    public void modify(ThirdToMainBean mainBean, TopBtn topBtn) {
