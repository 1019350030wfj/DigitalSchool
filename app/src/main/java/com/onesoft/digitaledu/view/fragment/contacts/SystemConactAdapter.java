...
import com.onesoft.digitaledu.view.activity.infomanager.contacts.ContactInfoActivity;
 ...
 */
public class SystemConactAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public SystemConactAdapter(Context context) {
        mContext = context;
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case TreeItem.ITEM_TYPE_PARENT2: {
                view = LayoutInflater.from(mContext).inflate(
                        R.layout.item_tree_recycler_contact2, parent, false);
                return new TreeItem2Holder(view);
            }
            case TreeItem.ITEM_TYPE_PARENT3: {
                view = LayoutInflater.from(mContext).inflate(
                        R.layout.item_tree_recycler_contact_3, parent, false);
            ...
            case TreeItem.ITEM_TYPE_CHILD: {
                ...
                textViewHolder.bindView(mDataSet.get(position), new OnTreeDetailClickListener() {
                    ...
                    public void onClick(TreeItem itemData) {
                        ContactInfoActivity.startInfoActivity(mContext,itemData);
                    }
                });
                break;
            }
