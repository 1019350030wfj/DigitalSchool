...
public class ViewHolder21 extends BaseViewHolder {
    ...
    public ViewHolder21(Context context) {
        mContext = context;
        mSingleSelectBeen = new ArrayList<>();
        mSingleSelectBeen.add(new SingleSelectBean("停用", "0"));
        mSingleSelectBeen.add(new SingleSelectBean("空闲", "1"));
        mSingleSelectBeen.add(new SingleSelectBean("使用中", "2"));
        mSingleSelectBeen.add(new SingleSelectBean("修建中", "3"));
    }
