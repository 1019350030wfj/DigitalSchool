...
import com.onesoft.digitaledu.presenter.infomanager.docsendrec.SendingDocumentPresenter;
import com.onesoft.digitaledu.view.activity.infomanager.docsendrec.DocDetailSendActivity;
...
public class SendingDocFragment extends BaseFragment<SendingDocumentPresenter> implements PtrListView.OnRefreshListener, PtrListView.OnLoadMoreListener, ISendingBoxView {

    private PtrListView mListView;
    private BoxAdapter mBoxAdapter;

    public static SendingDocFragment newInstance(String s) {
        SendingDocFragment newFragment = new SendingDocFragment();
    ...
    public void initListener() {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                DocDetailSendActivity.startDetail(getActivity(), mBoxAdapter.getItem(position));
            }
        });
    }
    ...
    protected void initPresenter() {
        mPresenter = new SendingDocumentPresenter(getActivity(), this);
    }
    ...
    public void onBaseEvent(final BaseEvent event) {
        switch (event.type) {
            case BaseEvent.SEND_DOCUMENT: {//发送消息成功
                onRefresh();//刷新发件箱列表
                break;
            }
        }
