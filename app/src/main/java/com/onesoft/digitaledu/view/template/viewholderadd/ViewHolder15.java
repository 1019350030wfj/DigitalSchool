...
public class ViewHolder15 extends BaseViewHolder {

    protected TextView mTxtName;
    protected TextView mTxtContent;
    protected ImageView img_select;

    protected List<SelectDistrict> mRoles;

    public ViewHolder15(Context context) {
        mContext = context;
    }
        ...
        img_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mRoles == null) {//服务器获取数据
                    ...
                    commonPresenter.getSelectDistrict(new TemplateCommonPresenter.ISelectDistrict() {
                        @Override
                        public void onGetSelectDistrict(List<SelectDistrict> roles) {
                            mRoles = roles;
    ...
    private void showSelectRoleDialog(TopBtn mTopBtn, int position) {
        ...
        SingleSelectDialog dialog = new SingleSelectDialog<SelectDistrict>(mContext) {
            @Override
            public SingleSelectAdapter getAdapter() {
                return new SingleSelectAdapter(mContext){
                    ...
                    public void bindView(TextView textView,int pos) {
                        textView.setText(mRoles.get(pos).district_name);
                    }
                };
            }
        };
        ...
        dialog.setDialogListener(new SingleSelectDialog.IDialogClick<SelectDistrict>() {
            @Override
            public void onConfirm(SelectDistrict bean,int pos) {
    ...
    protected void updateTemplateBean(Template10Bean template10Bean, SelectDistrict bean) {
        template10Bean.showValue = bean.district_name;
