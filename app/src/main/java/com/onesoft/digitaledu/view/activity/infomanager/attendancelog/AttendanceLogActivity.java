...
import com.onesoft.digitaledu.view.fragment.infomanager.MonthFragment;
import com.onesoft.digitaledu.view.fragment.infomanager.YearFragment;

/**
 * 考勤日志
 * Created by Jayden on 2017/01/04.
 */
public class AttendanceLogActivity extends ToolBarActivity<BasePresenter>{
    ...
    public void initListener() {
        ...
        mTxtYear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //弹出PopupWindow
                LinearLayout container = (LinearLayout) LayoutInflater.from(AttendanceLogActivity.this).
    ...
    public void initData() {
        setTitle(getString(R.string.attendance_look));
        showMonthFragment();
