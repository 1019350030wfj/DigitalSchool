 ...
 */
public abstract class ThirdMainToRecoveryListActivity<T extends BasePresenter> extends ToolBarActivity<T> implements IThirdToMainView,PtrListView.OnRefreshListener, PtrListView.OnLoadMoreListener {
