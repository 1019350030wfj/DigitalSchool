...
import com.onesoft.digitaledu.view.iview.IListView;
 ...
 */
public abstract class AbsListActivity<D> extends ToolBarActivity<ListPresenter> implements IListView<D> {
    ...
    protected BaseAbsListAdapter mDetailAdapter;
...
//                    int lastItemPosition = linearManager.findLastVisibleItemPosition();
    ...
    @Override
    public void onSuccess(List<MenuTitle> titles, List<D> details) {
        mTitleAdapter.setTitles(titles);
        mDetailAdapter.setDatas(details);
    ...
    public void updateDeleteNum(String content) {
        getSupportActionBar().setTitle(getResources().getString(R.string.already_select_delete1, content));
    }
    ...
    protected abstract void initDetailAdapter();
    protected abstract void initNavRightView(View view);
}
