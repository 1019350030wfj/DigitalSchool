...
public class ViewHolder6 extends BaseViewHolder {
    ...
    public ViewHolder6(Context context) {
        mContext = context;
        mSingleSelectBeen = new ArrayList<>();
        mSingleSelectBeen.add(new SingleSelectBean(context.getString(R.string.man),"1"));
        mSingleSelectBeen.add(new SingleSelectBean(context.getString(R.string.woman),"0"));
    }
