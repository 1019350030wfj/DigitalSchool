...
public class DepartmentAddActivity extends ToolBarActivity<UserAddPresenter> implements IUserAddView {
    ...
    public View initContentView(LayoutInflater inflater) {
        return inflater.inflate(R.layout.activity_department_add, null);
    }

    @Override
    public void initView() {
        setTitle(getString(R.string.department_add_info));
