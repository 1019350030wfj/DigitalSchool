...
/**
 * Created by liyang on 2016/9/23.
 */
...
public class SolarTermsUtil {
     ...
     * 用于保存24节气
     */
    private  String[] principleTermNames = { "大寒", "雨水", "春分", "谷雨",
            "小满", "夏至", "大暑", "处暑", "秋分", "霜降", "小雪", "冬至" };
    /**
     * 用于保存24节气
     */
    private  String[] sectionalTermNames = { "小寒", "立春", "惊蛰", "清明",
            "立夏", "芒种", "小暑", "立秋", "白露", "寒露", "立冬", "大雪" };

    public  void solarTermsUtil(int year, int month, int day) {
    ...
    // 大闰月的闰年年份
    private  int[] bigLeapMonthYears = { 6, 14, 19, 25, 33, 36, 38, 41,
