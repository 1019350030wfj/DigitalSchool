...
public class AgendaAddPresenter extends BasePresenter<IAddView> {

    public AgendaAddPresenter(Context context, IAddView iView) {
        super(context, iView);
    }
     ...
     * @param end
     */
    public void addAgenda(String title,String schedule_category,String start,String end,
        ...
        params.add(new HttpHandler.Param("template_id", "104"));
