...
import com.onesoft.digitaledu.widget.calendar.presenter.AgendaAddPresenter;
 ...
 */
public class AgendaAddActivity extends ToolBarActivity<AgendaAddPresenter> implements IAddView {
    ...
    private String mSelectRemind = "1";//默认无
    ...
    protected void initPresenter() {
        mPresenter = new AgendaAddPresenter(this, this);
    }
    ...
    public void initView() {
        setTitle(getString(R.string.add_agenda));
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {//提交
                mPresenter.addAgenda(mEventTitle.getText().toString().trim(), mSelectMessageType, mTitleFromTime.getText() + " " + mTitleFromTimeHour.getText(),
    ...
    public void initListener() {
        mTitleFromTimeHour.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (fromHourPicker == null) {
                    fromHourPicker = new CustomHourPicker(AgendaAddActivity.this, new CustomHourPicker.ResultHandler() {
                        @Override
        ...
        mTitleToTimeHour.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (toHourPicker == null) {
                    toHourPicker = new CustomHourPicker(AgendaAddActivity.this, new CustomHourPicker.ResultHandler() {
                        @Override
                        public void handle(String time) {
        ...
        mTitleFromTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (fromDatePicker == null) {
                    fromDatePicker = new CustomDatePicker(AgendaAddActivity.this, new CustomDatePicker.ResultHandler() {
                        @Override
        ...
        mTitleToTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (toDatePicker == null) {
                    toDatePicker = new CustomDatePicker(AgendaAddActivity.this, new CustomDatePicker.ResultHandler() {
                        @Override
                        public void handle(String time) { // 回调接口，获得选中的时间
        ...
        mImgSelect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SingleSelectDialog dialog = new SingleSelectDialog<SingleSelectBean>(AgendaAddActivity.this) {
                    @Override
                    public SingleSelectAdapter getAdapter() {
                        return new SingleSelectAdapter(AgendaAddActivity.this) {
                            @Override
    ...
    public void onAddSuccess() {
        EventBus.getDefault().post(new BaseEvent(BaseEvent.UPDATE_AGENDA,""));
        finish();
    }
}
