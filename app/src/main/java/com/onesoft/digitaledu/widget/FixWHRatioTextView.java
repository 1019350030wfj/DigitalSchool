...
public class FixWHRatioTextView extends TextView {

    private float wh_ratio=1.0f;//默认宽高比

    public FixWHRatioTextView(Context context) {
        super(context);
        init(context,null);
    }

    public FixWHRatioTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context,attrs);
    }

    public FixWHRatioTextView(Context context, AttributeSet attrs, int defStyleAttr) {
