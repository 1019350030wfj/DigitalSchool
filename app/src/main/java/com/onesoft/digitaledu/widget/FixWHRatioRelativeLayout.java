...
public class FixWHRatioRelativeLayout extends RelativeLayout {

    private float wh_ratio = 1.0f;//默认宽高比

    public FixWHRatioRelativeLayout(Context context) {
        super(context);
        init(context, null);
    }

    public FixWHRatioRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public FixWHRatioRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
