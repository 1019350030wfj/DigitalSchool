package com.onesoft.digitaledu.widget.wheel;
...
public class CustomHourPicker {
    ...
    private TextView year_text, month_text, day_text, hour_text, minute_text,title_text;
    private Button tv_cancle, tv_select;

    public CustomHourPicker(Context context, ResultHandler resultHandler, String startDate, String endDate) {
    ...
    private void initDialog() {
        if (datePickerDialog == null) {
            datePickerDialog = new Dialog(context, R.style.dialog_transparent);

            datePickerDialog.setCancelable(true);
            datePickerDialog.setCanceledOnTouchOutside(false);
            datePickerDialog.setContentView(R.layout.dialog_select_hour);
    ...
    private void initView() {
        ...
        tv_cancle = (Button) datePickerDialog.findViewById(R.id.negativeButton);
        tv_select = (Button) datePickerDialog.findViewById(R.id.positiveButton);
        ...
        title_text = (TextView) datePickerDialog.findViewById(R.id.title);
...
//                monthChange();
        ...
        day_pv.setOnSelectListener(new DatePickerView.onSelectListener() {
            ...
            public void onSelect(String text) {
                ...
                mSelectDay = Integer.parseInt(text);
//                hourChange();
            }
        });
...
//                minuteChange();
    ...
    private void dayChange() {
        ...
        day_pv.setData(day);
        day_pv.setSelected(mSelectDay > day.size() ? 0 : mSelectDay - 1);
    ...
    public void hideYearMonthDay() {
        if (canAccess) {
            ...
            hour_text.setGravity(Gravity.LEFT | Gravity.CENTER_VERTICAL);
            minute_text.setGravity(Gravity.LEFT | Gravity.CENTER_VERTICAL);
    ...
    public void setSelectedTime(String time) {
        if (canAccess) {
            ...
            mSelectDay = Integer.parseInt(dateStr[2]);
