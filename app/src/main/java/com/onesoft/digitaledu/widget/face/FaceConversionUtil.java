package com.onesoft.digitaledu.widget.face;
...
public class FaceConversionUtil {
    ...
    private void dealExpression(Context context,
        ...
        while (matcher.find()) {
            ...
            if (resId != 0) {
                ...
                bitmap = Bitmap.createScaledBitmap(bitmap, (int) (bitmap.getWidth() * 1.2), (int) (bitmap.getHeight() * 1.2), true);
    ...
    private List<ChatEmoji> getData(int page) {
        ...
        if (list.size() == pageSize) {
            ChatEmoji object = new ChatEmoji();
            object.setId(R.drawable.sns_content_goback);
            list.add(object);
        }
        return list;
    }
