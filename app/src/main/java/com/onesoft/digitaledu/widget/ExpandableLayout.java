...
/**
 * Created by Jayden on 2016/10/13.
 */
...
public class ExpandableLayout extends RelativeLayout {
    ...
    private void expand(final View v) {
        if (mContentHeight == 0){
            ...
            v.getLayoutParams().height = mContentHeight;
        }
...
//        v.startAnimation(animation);
    ...
    private IExpandResult mResultListener;

    public void setExpandResultListener(IExpandResult resultListener) {
        this.mResultListener = resultListener;
    }

    public interface IExpandResult {
        void onResult(boolean isExpand);
    }
}
