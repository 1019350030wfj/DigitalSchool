...
public interface IPhotoView {
	...
	/**
	 * @return 获取当前缩小的最小等级。该值依赖于当前的 {@link ImageView.ScaleType} .
	 */
	float getMinScale();

	/**
	 * @return 获取当前缩小的中等等级。该值依赖于当前的 {@link ImageView.ScaleType} .
	 */
	float getMidScale();

	/**
	 * @return 获取当前缩小的最大等级。该值依赖于当前的 {@link ImageView.ScaleType} .
	 */
	float getMaxScale();
	...
	/**
	 * 设置当前缩小的最小等级。该值依赖于当前的 {@link ImageView.ScaleType}.
	 */
	void setMinScale(float minScale);

	/**
	 * 设置当前缩小的中等等级。该值依赖于当前的 {@link ImageView.ScaleType}.
	 */
	void setMidScale(float midScale);

	/**
	 * 设置当前缩小的最大等级。该值依赖于当前的 {@link ImageView.ScaleType}.
	 */
