...
public class FilePickerActivity extends AppCompatActivity implements DirectoryFragment.FileClickListener {
    ...
    public static final String ARG_SHOW_CONFIRM = "show_confirm";
    ...
    private void initArguments() {
        ...
        if (getIntent().hasExtra(ARG_SHOW_CONFIRM)) {
            isShowConfirm = getIntent().getBooleanExtra(ARG_SHOW_CONFIRM, false);
        }
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        View view = LayoutInflater.from(this).inflate(R.layout.menu_setting, null);
    ...
    private void setResultAndFinishDir() {
        Intent data = new Intent();
        data.putExtra(RESULT_DIR_PATH, mCurrentPath);
        setResult(RESULT_OK, data);
        finish();
    }
}
