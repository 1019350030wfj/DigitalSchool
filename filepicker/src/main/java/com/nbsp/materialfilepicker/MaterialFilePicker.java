...
public class MaterialFilePicker {
    ...
    private boolean isShowConfirm = false;//是否显示确定
     ...
     * Show or hide hidden files in picker
     */
    public MaterialFilePicker withShowConfirm(boolean show) {
        isShowConfirm = show;
        return this;
    }
    ...
    public Intent getIntent() {
        ...
        intent.putExtra(FilePickerActivity.ARG_SHOW_CONFIRM, isShowConfirm);
