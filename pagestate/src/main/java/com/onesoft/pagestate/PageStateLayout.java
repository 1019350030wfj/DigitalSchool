...
import com.onesoft.pagestate.utils.DimenUtils;
import com.onesoft.pagestate.utils.PageState;
import com.onesoft.pagestate.widget.MaterialProgress;
import com.onesoft.pagestate.widget.RippleView;
...
public class PageStateLayout extends FrameLayout implements PageStateListener {
    ...
    static class PageStateSavedState extends BaseSavedState {
        ...
        private static final Creator<PageStateSavedState> mCreator = new Creator<PageStateSavedState>() {
            @Override
